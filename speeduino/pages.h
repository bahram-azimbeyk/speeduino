...
constexpr uint8_t calibrationPage = 16; //Sensor calibration tables (CLT/IAT/O2). Exposed as a page so calibrations are part of the tune (.msq)
constexpr uint8_t MIN_PAGE_NUM  = veSetPage;
constexpr uint8_t MAX_PAGE_NUM  = (calibrationPage+1U);
